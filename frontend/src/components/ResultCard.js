          ...
          <div className="mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 bg-sky-500 hover:bg-sky-600 text-white font-medium rounded-lg transition-colors duration-200"
         ...
         {/* Sección de valoración */}
          {!isObligated && (
            <div className="bg-gray-50 rounded-xl p-5 mb-6">
              <p className="text-gray-700 font-medium mb-3">¿Te ha resultado útil la app?</p>

              {/* Fila: Reseña web + Play Store */}
              ...
              {/* Comentario opcional (solo si ya seleccionó estrellas y no enviado) */}
