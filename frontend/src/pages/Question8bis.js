        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">
              ¿Tus ingresos han sido exclusivamente del trabajo, de capital, de actividades económicas, así como ganancias patrimoniales, y no han superado los 1.000 euros en conjunto?
            </h1>
