...
const RetentionVariableQuestionAlava = () => {
  ...
  const handleNext = () => {
    ...
    // Redirigir según el número de pagas del territorio Alava
    const payments = answers?.annual_payments;
    if (payments === '14') {
      navigate('/salary/alava/calculator-14');
    } else if (payments === '15') {
      navigate('/salary/alava/calculator-15');
    } else {
      navigate('/salary/alava/calculator-12');
    }
  };

  const handlePrevious = () => {
    // Volver según el número de pagas del territorio Alava
    const payments = answers?.annual_payments;
    if (payments === '14') {
      navigate('/salary/alava/calculator-14');
    } else if (payments === '15') {
...
export default RetentionVariableQuestionAlava;
