...
const RetentionVariableQuestionBizkaia = () => {
  ...
  const handleNext = () => {
    ...
    // Redirigir según el número de pagas del territorio Bizkaia
    ...
    if (payments === '14') {
      ...
      navigate('/salary/bizkaia/calculator-12');
    }
  };

  const handlePrevious = () => {
    // Volver según el número de pagas del territorio Bizkaia
    const payments = answers?.annual_payments;
    if (payments === '14') {
      navigate('/salary/bizkaia/calculator-14');
    } else if (payments === '15') {
...
export default RetentionVariableQuestionBizkaia;
