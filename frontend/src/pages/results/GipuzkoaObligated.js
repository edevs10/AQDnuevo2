      ...
      mainMessage={
        <>
          <p className="text-orange-600 text-lg font-semibold mb-4">
            Según tus respuestas, SÍ tienes obligación de presentar la declaración de la Renta 2025 bajo la normativa foral de Gipuzkoa (según normativa a {formattedDate})
          </p>
      ...
      additionalContent={
        <div className="bg-blue-50 border-l-4 border-blue-300 p-5 rounded-r-lg text-left">
          ...
          <p className="text-gray-700 mb-3">
            <strong>Organismo:</strong> Hacienda Foral de Gipuzkoa
          </p>
...
export default GipuzkoaObligated;
