...
const RetentionVariableQuestionCommon = () => {
  ...
  const handleNext = () => {
    ...
    // Redirigir según el número de pagas del territorio Common
  ...
  const handlePrevious = () => {
    // Volver según el número de pagas del territorio Common
    const payments = answers?.annual_payments;
    if (payments === '14') {
      navigate('/salary/common/calculator-14');
    } else if (payments === '15') {
...
export default RetentionVariableQuestionCommon;
